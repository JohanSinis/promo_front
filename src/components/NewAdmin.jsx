...
const NewAdmin = () => {
    ...
    return (
        <div className="new-admin-container">
            <h2 className="new-admin-title">CREAR ADMIN</h2>
            <form onSubmit={handleRegister}>
                ...
                <button className="register-button" type="submit">GUARDAR ADMIN</button>
                <button className="back-button" type="button" onClick={() => navigate('/admin')}>VOLVER AL LOGIN</button>
                {mensaje && (
